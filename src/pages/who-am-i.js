...
export default function WhoAmI() {
    return (
        <div className="row mx-3">
            ...
            <div className="col-sm-12 col-md-3 mb-3 order-first order-md-last mx-auto float-md-right">
                <img src={jack} alt="Jack Owen" className="mx-auto w-100"></img>
                <p className="d-none d-md-block text-left mx-auto text-secondary">This is a picture of a younger, better me! To say I look exactly the same would be a stretch... but you get the idea!</p>
            </div>
